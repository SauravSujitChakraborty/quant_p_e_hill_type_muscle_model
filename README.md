...
The Trade-off: As shortening velocity increases, the number of active cross-bridges in the muscle decreases, causing force to drop hyperbolically. Maximum power is the "sweet spot" where these two inverse variables produce the highest product given by the equation :- $P = F \cdot v$
